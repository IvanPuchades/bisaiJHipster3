(function() {
    ...
    EquipoDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Equipo', 'Jugador', 'Clasificacion'];

    function EquipoDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Equipo, Jugador, Clasificacion) {
        var vm = this;
